      ...
      <div className="container mx-auto px-6">
        ...
        >
          {projectsData.map((project, index) => (
            ...
            >
              <Link href={`/projects/${project.slug}`} className="relative h-56 overflow-hidden block">
                <Image
                  src={project.image}
                  alt={project.title}
                  fill
                ...
                {/* Status Badge */}
                {index < 2 && (
                  <div className="absolute top-4 right-4 glass px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider border-accent-cyan/20 text-accent-cyan shadow-xl z-10">
                    Production
                  </div>
                )}
              </Link>
              ...
              <div className="p-8 flex-1 flex flex-col">
                ...
                <Link href={`/projects/${project.slug}`}>
                  <h4 className="text-2xl font-bold mb-3 tracking-tight group-hover:text-accent-cyan transition-colors cursor-pointer">
                    {project.title}
                  </h4>
                </Link>
