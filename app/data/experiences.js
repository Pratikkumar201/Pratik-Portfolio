...
const experiences = [
  {
    ...
    projects: [
      {
        name: "Expert Intelligence AI - UPSC",
        details: [
          "Reduced expert panel generation time from hours to under 5 minutes by building an end-to-end AI pipeline for automated shortlisting.",
          "Designed multi-stage system: SQL filtering → BERT embeddings → FAISS semantic retrieval → Random Forest ranking → Linear Programming optimization.",
          "Processed and optimized 17,000+ expert profiles with 100% compliance to complex diversity and institutional constraints."
      ...
      {
        name: "AI Governance OS - Ministry of Youth Affairs & Sports",
        details: [
          "Engineered a WhatsApp-first 'Zero Browser' operating system for senior officials using Claude Sonnet and Interakt API for natural language task management.",
          "Built Active Reminder Engine with 7-level escalation cascade (Supabase pg_cron), auto-generating follow-up communications for pending tasks.",
          "Developed People Intelligence layer with RACI-based workload scoring and bottleneck detection across personnel.",
      ...
      {
        name: "Parivesh 3.0 — AI-Powered Environmental Clearance System",
        details: [
          "Building the AI/ML layer for PARIVESH 3.0, MoEF&CC's national single-window platform for environmental, forest, wildlife, and coastal clearances across India.",
          "Designed multi-agent agentic AI system for automated proposal scrutiny, project classification (A/B1/B2), GIS-based sensitive area flagging, and deficiency detection — integrated into the existing PARIVESH portal via microservices APIs.",
          "Built OCR pipeline to extract structured data from scanned government documents and EIA reports, enabling auto-population of form fields and cross-validation against PP-submitted data to flag mismatches and deficiencies.",
          "Built RAG + Agentic chatbot for 24×7 guidance on EC/FC/WL/CRZ processes with real-time proposal status via MoEFCC APIs; NLP pipeline for EIA report summarization and clustering of public hearing comments into thematic groups (displacement, water, biodiversity).",
          "Automated Agenda Note generation for EAC/SEAC committee meetings; system deployed on AWS with Claude API, Cohere embeddings, and AWS OpenSearch, following GoI IT security and data privacy standards."
        ],
        tools: ["Claude API", "LangGraph", "RAG", "AWS OpenSearch", "GIS APIs", "OCR", "PyMuPDF", "Tesseract", "NLP", "spaCy", "Scikit-learn", "Cohere Embeddings", "Python", "FastAPI", "MongoDB", "Docker", "AWS EC2"]
      }
    ],
    skills: ["GenAI", "LangChain", "LangGraph", "RAG", "BERT", "FAISS", "NestJS", "AWS", "Docker", "GIS", "NLP"]
  },
  {
    slug: "bhu-software-developer",
    title: "Software Developer",
